...
var orecorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = orecorenode.version;
  var create = orecorenode.scaffold.create;
  var add = orecorenode.scaffold.add;
  var start = orecorenode.scaffold.start;
  var remove = orecorenode.scaffold.remove;
  var callMethod = orecorenode.scaffold.callMethod;
  var findConfig = orecorenode.scaffold.findConfig;
  var defaultConfig = orecorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Galactrum database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `orecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ orecore-node add wallet-service');
      console.log('    $ orecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ orecore-node remove wallet-service');
      console.log('    $ orecore-node remove insight-api');
      console.log();
    });
