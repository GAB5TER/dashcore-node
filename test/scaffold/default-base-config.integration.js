...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    galactrumd.spawn.datadir.should.equal(home + '/.galactrum');
    galactrumd.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.galactrum/galactrumd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.galactrumd.spawn.datadir.should.equal('./data2');
  });
});
